...
class SandwichController extends AbstractController{
  ...
  static public function add($id_commande, $taille, $type){
    ...
    return $chaine;
      ...
      static public function modifySandwich($id_sandwich, $type_de_pain, $taille){
  ...
  public function modifyIngredients($salade, $crudite, $viande, $sauce,$fromage){
