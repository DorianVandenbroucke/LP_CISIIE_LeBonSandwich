define({ "api": [
  ...
  },
  {
    ...
    "version": "0.1.0",
    "type": "get",
    "url": "/commandes/{id}/sandwichs/{id_sandwich}/ingredients[/]",
    "title": "Afficher",
    "description": "<p>On affiche les ingrédients d'un sandwich</p> <p>Retourne une représentation json de la ressource</p>",
    "success": {
      "fields": {
        "Succès : 200": [
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "nb_ingredients",
            "description": "<p>Nombre d'ingrédients dans le sandwich</p>"
          },
          {
            "group": "Succès : 200",
            "type": "Array",
            "optional": false,
            "field": "ingredients",
            "description": "<p>Tableau contenant les ingrédients liés au sandwich</p>"
          },
          {
            "group": "Succès : 200",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "links",
            "description": "<p>Lien de l'ingrédient</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "description": "<p>On ajoute un ingrédient si celui-ci n'est pas encore présent dans le sandwich ou on supprime un ingrédient dans un sandwich si celui-ci existe déjà</p> <p>Retourne une représentation json</p>",
    "success": {
      "examples": [
        {
          "title": "Exemple de réponse en cas de succès",
        ...
        "Succès : 200": [
          {
            ...
            "optional": false,
            "field": "taille",
            "description": "<p>Nouvelle taille du sandwich</p>"
          },
          {
            "group": "Succès : 200",
            "type": "String",
            "optional": false,
            "field": "type",
            "description": "<p>Nouveau type du sandwich</p>"
          },
          {
            "group": "Succès : 200",
            "type": "Link",
